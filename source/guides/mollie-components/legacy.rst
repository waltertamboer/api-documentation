Mollie Components beta
======================

.. warning:: The beta version of Mollie Components has been deprecated. To benefit from a frictionless 3D Secure authentication
             for your customers, we recommend you to use the latest version of :doc:`Mollie Components </guides/mollie-components/overview>`.

             To upgrade to the latest version of Mollie Components, refer to our :doc:`upgrade guide </guides/mollie-components/upgrade-guide>`.
...
.. warning:: The API functions listed below are deprecated We encourage you to upgrade to the latest version of :doc:`Mollie Components </guides/mollie-components/overview>`.

             Please refer to our :doc:`upgrade guide </guides/mollie-components/upgrade-guide>` for more information.
