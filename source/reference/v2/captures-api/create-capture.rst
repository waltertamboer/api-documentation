...
Manual capture is supported for some payment methods that the *authorize-then-capture* flow. Currently this is supported for credit card payments
created with ``delayCapture`` parameter.

Parameters
----------
Replace ``paymentId`` in the endpoint URL by the payment's ID. For example:
``/v2/payments/tr_7UhSN1zuXS/captures``.
     ...
     - The amount to capture.
       ...
       .. list-table::
          ...
          * - ``value``
            ...
            - A string containing the exact amount you want to capture in the given currency. Make sure to send the right
